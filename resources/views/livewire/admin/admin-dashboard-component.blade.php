              ...
              <div class="icon-stat">
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{ $totalRevenue }}DT</span>
                  </div>
              ...
              <div class="icon-stat">
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{ $totalSales }}DT</span>
                  </div>
                  <div class="col-xs-4 text-center">
              ...
              <div class="icon-stat">
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{ $todayRevenue }}DT</span>
                  </div>
                  <div class="col-xs-4 text-center">
                    <i class="icon icon-dollar icon-stat-visual bg-primary"></i>
                  </div>
              ...
              <div class="icon-stat">
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{ $todaySales }}DT</span>
                  </div>
                  <div class="col-xs-4 text-center">
                    <i class="icon icon-gift icon-stat-visual bg-secondary"></i>
                  </div>
