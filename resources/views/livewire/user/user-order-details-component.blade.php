                    ...
                    <div class="panel-header mb-5">
                        <div class="row">
                            ...
                            <div class="col-md-3 header-right">
                                <a href="{{ route('user.orders') }}" style="margin-right: 5px;" class="btn btn-success header-right">All orders</a>
                                @if ($order->status == 'ordered')
                                <a href="#" wire:click.prevent="cancelOrder"  class="btn btn-danger header-right">Cancel order</a>
