...
class CategoryComponent extends Component
{
    ...
    public function render()
    {
        ...
        $category_name = "";
        $filter = "";
        if($this->sscategory_slug)
        {
            $sscategory = scategory::where('slug',$this->sscategory_slug)->first();
            $category_id = $sscategory->id;
            $category_name = $sscategory->name;
            $filter = "sub";
        }
        elseif($this->scategory_slug)
        {
